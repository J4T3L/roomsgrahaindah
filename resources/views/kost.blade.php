                    ...
                    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                @if ($kost->image)
                                    <a href="{{ asset('public/storage/post-images/' . $kost->image) }}" data-toggle="lightbox"
        ...
        <div class="col-8 col-lg-8 col-md-8">
            ...
            <article class="header__kos">
                ...
                <div class="col-12 col-lg-12 col-md-12 hadiah__sevenkos">
                    <h4 class="fw-bold">Yang Kamu dapatkan di Graha Indah</h4>
                    <div class="mb-3 d-flex align-items-lg-center hadiah__sevenkos-1">
                        ...
                        <p style="margin-left: 10px; display: inline-block; width: 550px">Bebas biaya admin,
                            kamu tidak akan dikenakan biaya admin saat melakukan pembayaran di Graha Indah.</p>
                    </div>
                    ...
                    <div class="d-flex align-items-lg-center hadiah__sevenkos-4">
                        ...
                        <p style="margin-left: 10px; display: inline-block; width: 550px">Dikelola Graha Indah,
