...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-transparent position-fixed">
        <div class="container">
            ...
            <a class="navbar-brand page-scroll" href="#home">Kos Graha Indah</a>
    ...
    <section id="hero">
        <div class="container h-100">
            <div class="row h-100">
                <div class="col-md-6 hero-tagline my-auto mt-auto" style="z-index: 2;">
                    ...
                    <p class="subtitle_header" style="--duration: 1s">
                        <span class="fw-bold" style="--delay: .7s">Graha indah</span><span
            ...
            <img src="\img\homebanner.png" alt="" class="position-absolute end-0 bottom-0 img-hero">
        ...
        <div class="container elemen">
            <div class="row">
                <div class="col-12 text-center">
                    ...
                    <span class="sub-title">Graha Indah hadir menjadi solusi bagi kamu</span>
                </div>
            </div>
            <div class="row mt-5">
                <div class="col-md-4 text-center mb-4">
                    <a href="/posts" class="text-decoration-none">
                        <div class="card-layanan">
                            ...
                            <p class="mt-3">Graha Indah kini jadi kenyataan, sewa kos bary dengan fasilitas terbaik
                ...
                <div class="col-md-4 text-center mb-4">
                    <a href="/posts" class="text-decoration-none">
                        <div class="card-layanan">
                            ...
                            <h3 class="mt-4">cari Kos</h3>
                            <p class="mt-3">cari Kos sempurna dengan harga terbaik kualitas terjamin dari sumber
                                terpercaya.</p>
                        </div>
                    </a>
    ...
    <section class="about" id="about">
        <div class="container-fluid d-flex mt-5 bg__about elemen"
            ...
            <div class="row col-12 col-md-12 col-lg-12">
                <div class="col-6">
                    <h5 class="fw-bold mb-3 mt-5">Graha Indah - Website Anak Kos di Indonesia</h5>
                    <p class="text-justify">Lorem ipsum dolor sit amet consectetur adipisicing elit. Laboriosam, minima. Ex nulla error ut ducimus vero repellat nesciunt fuga quam explicabo ipsa distinctio, libero animi voluptas? Enim et nisi voluptatibus.
                    </p>
                    <p class="mb-5 text-justify">
                        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Similique libero impedit minima, est consequatur iste adipisci quisquam sequi sint quos beatae hic debitis asperiores qui minus harum optio eligendi magnam.
                    </p>
                ...
                <div class="col-6 mt-5">
                    ...
                    <p class="ml-3 text-justify">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas inventore natus facere corrupti, commodi aspernatur est voluptates possimus nisi saepe sunt eius deserunt adipisci ab sequi nihil, cumque vel soluta!
                    </p>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <p>
                            Dapatkan "info kos murah" hanya di Graha Indah. Mau "Sewa Kost Murah"?
                        </p>
                    ...
                    <div class="col-md-3 menu__contact">
                        <h5 class="text-uppercase font-weight-bold mb-2">Graha Indah</h5>
                        ...
                        <ul class="list-unstyled mb-0 text-decoration-none">
                            ...
                            <li class="mb-2 mb-">
                                <a href="/blog" class="text-decoration-none">Blog Graha Indah</a>
                            </li>
                            <li class="mb-2">
                        ...
                        <div class="contact">
                            ...
                            <div class="kontak">
                                ...
                                <div class="mb-3 d-flex align-items-lg-center">
                                    ...
                                    <a href="https://goo.gl/maps/" class="text-decoration-none"
                                        style="margin-left: 18px; display: inline-block; width: 550px"> surabaya
                                    </a>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <a href="#" class="text-decoration-none"
                                        style="margin-left: 18px">grahaindah@gmail.com</a>
                                </div>
                            ...
                            <div class="sosial">
                                ...
                                <a href="https://instagram.com" class="me-3"><img src="/img/ig.png" alt=""></a>
                            </div>
                        </div>
                        <!--Grid column-->
                    </div>
        ...
        <div class="container-fluid">
            <div class="container">
                <div class="row">
                    <div
                        ...
                        <h5 class="text-uppercasetext-decoration-none text-light"><a href="/">
                                <img src="/img/logo.jpg" width="55" height="55"
                                    class="img-thumbnail rounded-circle mr-5"></a>Graha Indah
                        </h5>
                    </div>
                ...
                <div class="row position-absolute copy start-50 translate-middle">
                    <div class="col-12">
                        <p class="text-center">&copy; Tazzi </p>
                    </div>
                </div>
            </div>
        </div>
